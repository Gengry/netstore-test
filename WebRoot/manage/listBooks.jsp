...
<br />
<br />
<table align="center" border="1" width="638">
	<tr>
	...
	<c:forEach items="${page.records}" var="b" varStatus="vs">
		<tr class="${vs.index%2==0?'odd':'even'}">
			<td nowrap="nowrap"><input type="checkbox" name="ids"
				value="${b.id}">
			</td>
			...
			<td nowrap="nowrap"><img
				src="${pageContext.request.contextPath}/images${b.path}/${b.photoFileName}">
			</td>
			<td nowrap="nowrap"><a href="javascript:alert('略')">修改</a> <a
				href="javascript:alert('略')">删除</a>
			</td>
		</tr>
	</c:forEach>
</table>
