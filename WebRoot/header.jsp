...
<%@ taglib uri="http://www.imut.edu/functions" prefix="myfn" %>
...
<html>
  ...
  <body>
    ...
    <c:if test="${!empty sessionScope.customer}">
    	欢迎您：${sessionScope.customer.name} <a href="${pageContext.request.contextPath}/servlet/ClientServlet?op=logout">注销</a>
    </c:if>
    <c:if test="${empty sessionScope.customer}">
